...
const uint8_t MINIMUM_ANALOG_INFORMATION_PAYLOAD_SIZE = 108; // UserDefinedValue = 3, the baseline PACE firmware version
...
protected:
	...
	Protocol25Variant protocol25VariantInfo[Protocol25VariantCount] = 
	{
	    ...
	    // reported by johnmsole that Eenovance/Sunsynk packs have an 2 extra temperatures (2 * 4 bytes) plus an extra 28 bytes at the end
	    {
	        4,  // analogInformationUserDefinedValue
	        28, // analogInformationTrailingBytes
	        6,  // statusInformationTrailingBytes
	        36, // analogInformationTotalExtraBytes
...
// ============================================================================
	...
	struct StatusInformation
	{
		...
		// compact hex snapshot: sys=XX flt=XX bal=XXXX p1=XX p2=XX cfg=XX
		std::string rawStatusHex{ "" };
	};
